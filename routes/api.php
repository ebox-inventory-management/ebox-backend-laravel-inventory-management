...
Route::delete("supplier/delete/{id}", [SupplierController::class, "deleteSupplier"])->name("delete-supplier");
...
Route::delete("brand/delete/{id}", [BrandController::class, "deleteBrand"])->name("deleteBrands");
